...
void LightDemo::Initialize()
{
	...
	shader = new Shader(L"21_Light.fxo");
...
void LightDemo::Update()
{
	...
	ImGui::SliderFloat("EmssiveAlpha", &EmissiveColor.a, 1e-6f, 2);
